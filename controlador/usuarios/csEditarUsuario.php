                                ...
                                <div class="row">
                                    <div class="col-lg-12 d-flex stat my-4">
                                        <div class="mx-auto">
                                            ...
                                            $consulta = "SELECT * FROM login_ard WHERE IdUsuario='" . $id . "'";
                                            ...
                                            ?>
                                                <form class="row g-3" action="../usuarios/csActualizarUsuario.php" method="post">
                                                    ...
                                                    <div class="col-md-6 py-2">
                                                        ...
                                                        <input type="text" class="form-control" name="nombreusuario" value="<?php echo $datos['Usuario_Ard'] ?>" maxlength="20">
                                                    </div>

                                                    <div class="col-md-6 py-2">
                                                        <label for="inputAddress" class="form-label">Contraseña</label>
                                                        <input type="text" class="form-control" name="contrasena" value="<?php echo $datos['Clave_Ard'] ?>" maxlength="20">
                                                    </div>

                                                    <div class="col-md-6 py-2">
                                                            <label for="inputCity" class="form-label">Permiso a Asignar <span class = "red" style="color: red;">*</span></label>
                                                                <select class="form-control" id="rol" name="permiso" required maxlength="20">
                                                                    <option value="<?php echo $datos['Permiso_Ard'] ?>">    <?php echo $datos['Permiso_Ard'] ?></option>
                                                    ...
                                                    <div class="col-md-6 py-3">
                                                        ...
                                                        <a href="../../vista/usuarios.php" class="btn btn-success">Regresar</a>
                                                    </div>
