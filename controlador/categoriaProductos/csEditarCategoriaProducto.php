                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-9 col-md-8">
                                <h1 class="font-weight-bold mb-0">Edición de Categorías</h1><br>
                        </div>
                    </div>
                </section>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 d-flex stat my-4">
                                        <div class="mx-auto">
                                            ...
                                            $consulta = "SELECT * FROM categoria_productos_ard WHERE IdCategoriaProducto ='" . $id . "'";
                                            ...
                                            ?>
                                            <form class="row g-3" action="../categoriaProductos/csActualizarCategoriaProducto.php"
                                                method="post">
                                                <input type="hidden" class="form-control" name="txtid"
                                                    value="<?php echo $datos['IdCategoriaProducto'] ?>">
                                                <div class="col-md-12 py-2">
                                                    <label for="inputEmail4" class="form-label">Nombre de la
                                                        Categoría</label>
                                                    <input type="text" class="form-control" name="nCategoria"
                                                        maxlength="49" value="<?php echo $datos['CategoriaP_Nombre'] ?>">
                                                </div>
                                                <div class="col-md-12 py-2">
                                                    <label for="inputPassword4" class="form-label">Descripción</label>
                                                    <input type="text" class="form-control" rows="5" name="descripcion"
                                                        maxlength="249" value="<?php echo $datos['CategoriaP_Descripcion'] ?>"></input>
                                                </div>

                                                <div class="col-md-6 py-3">
                                                    <button type="submit" class="btn btn-warning"
                                                        value="Actualizar Información">Actualizar Información</button>
                                                    <a href="../../vista/categoriaProductos.php"
