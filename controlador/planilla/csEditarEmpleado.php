                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-9 col-md-8">
                                <h1 class="font-weight-bold mb-0">Edición de Empleados</h1><br>
                        </div>
                    </div>
                </section>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 d-flex stat my-4">
                                        <div class="mx-auto">
                                            ...
                                            $consulta = "SELECT * FROM planilla_ard WHERE IdEmpleado = '".$id."'";
                                            ...
                                            <form class="row g-3" action="../planilla/csActualizarEmpleado.php"
                                                method="post">

                                                <input type="hidden" class="form-control" name="txtid"
                                                    value="<?php echo $datos['IdEmpleado'] ?>">
                                                ...
                                                <div class="col-md-6 py-2">
                                                    ...
                                                    <input type="text" class="form-control" name="pnempleado"
                                                        placeholder="Ej: Daniel" maxlength="48" value="<?php echo $datos['Empleado_PrimerNombre'] ?>" required>
                                                </div>
                                                <div class="col-md-6 py-2">
                                                    ...
                                                    <input type="text" class="form-control" name="snempleado"
                                                        placeholder="Ej: Joel" maxlength="48" value="<?php echo $datos['Empleado_SegundoNombre'] ?>" required>
                                                </div>
                                                <div class="col-md-6 py-2">
                                                    <label for="inputNEmpleado" class="form-label">Tercer Nombre</label>
                                                    <input type="text" class="form-control" name="tnempleado"
                                                        placeholder="Ej: Pedro" maxlength="48" value="<?php echo $datos['Empleado_TercerNombre'] ?>">
                                                </div>
                                                ...
                                                <div class="col-md-6 py-2">
                                                    ...
                                                    <input type="text" class="form-control" name="paempleado"
                                                        placeholder="Ej: Mckenzie" maxlength="48" required value="<?php echo $datos['Empleado_PrimerApellido'] ?>">
                                                </div>
                                                <div class="col-md-6 py-2">
                                                    ...
                                                    <input type="text" class="form-control" name="saempleado"
                                                        placeholder="Ej: Juárez" maxlength="48" required value="<?php echo $datos['Empleado_SegundoApellido'] ?>">
                                                </div>
                                                <div class="col-md-6 py-2">
                                                    ...
                                                    <input type="number" class="form-control" name="dpi"
                                                        placeholder="Ej: 2014555587444" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                                                        maxlength="13" required value="<?php echo $datos['Empleado_DPI'] ?>">
                                                </div>
                                                <div class="col-md-6 py-2">
                                                    ...
                                                    <input type="date" class="form-control" name="fechanac"
                                                        ...
                                                        required value="<?php echo $datos['Empleado_FechaNacimiento'] ?>">
                                                </div>
                                                <div class="col-md-6 py-2">
                                                    <label for="inputDireccion" class="form-label">Dirección <span class = "red" style="color: red;">*</span></label>
                                                    <input type="text" class="form-control" name="direccion"
                                                        placeholder="Ej: Ciudad" maxlength="249" required value="<?php echo $datos['Empleado_Direccion'] ?>">
                                                </div>
                                                <div class="col-md-6 py-2">
                                                    ...
                                                    <input type="number"
                                                        ...
                                                        placeholder="Ej: 42521245" required value="<?php echo $datos['Empleado_Telefono'] ?>">
                                                </div>
                                                
                                                <div class="col-md-6 py-2">
                                                    <label for="inputPuesto" class="form-label">Puesto <span class = "red" style="color: red;">*</span></label>
                                                    <input type="text" class="form-control" name="puesto"
                                                        placeholder="Ej: Desarrollador/Programador" required maxlength="50" value="<?php echo $datos['Empleado_Puesto'] ?>">
                                                </div>
                                                <div class="col-md-6 py-2">
                                                    <label for="inputSueldo" class="form-label">Sueldo Inicial <span class = "red" style="color: red;">*</span></label>
                                                        ...
                                                        placeholder="Ej: 7000"
                                                        step="0.01" min="0" max="99999999999999999999" required value="<?php echo $datos['Empleado_SueldoInicial'] ?>">
                                                </div>
                                                ...
                                                <div class="col-md-6 py-2">
                                                    ...
                                                    <input type="number" class="form-control" name="sueldofinal"
                                                        ...
                                                        step="0.01" min="0" max="999999999999999" value="<?php echo $datos['Empleado_SueldoFinal'] ?>">
                                                </div>
                                                ...
                                                <div class="col-md-6 py-2">
                                                    ...
                                                    <select class="form-control" aria-label="Default select example" name="tipojornada" required>
                                                        <option value="<?php echo $datos['Empleado_JornadaLaboral'] ?>"><?php echo $datos['Empleado_JornadaLaboral'] ?></option>
                                                ...
                                                <div class="col-md-6 py-2">
                                                    ...
                                                    <input type="date" class="form-control" name="fechacontratacion"
                                                        ...
                                                        required value="<?php echo $datos['Empleado_FechaContratacion'] ?>">
                                                </div>
                                                <div class="col-md-6 py-2">
                                                    <label for="inputFecha" class="form-label">Fecha de
                                                        Retiro</label>
                                                    <input type="date" class="form-control" name="fecharetiro"
                                                        min="2000-01-01" max="2300-12-31" placeholder="Ej: 26/05/2021" value="<?php echo $datos['Empleado_FechaRetiro'] ?>">
                                                </div>
                                                <div class="col-md-6 py-2">
                                                <label for="inputFecha" class="form-label">Motivo de Retiro</label>
                                                    <select class="form-control" aria-label="Default select example" name="motivoretiro">
                                                        <option value="<?php echo $datos['Empleado_MotivoRetiro'] ?>"><?php echo $datos['Empleado_MotivoRetiro'] ?></option>
                                                        <option></option>
                                                ...
                                                <div class="col-md-12 py-2">
                                                    <label for="inputBeneficios" class="form-label">Beneficios y/o Contrato</label>
                                                    <input type="text" class="form-control"
                                                        placeholder="Ej: Bono de Comida y/o Prestaciones de Ley" name="beneficios" maxlength="50" value="<?php echo $datos['Empleado_Beneficios'] ?>">
                                                </div>

                                                <div class="col-md-6 py-3">
                                                        <button type="submit" class="btn btn-warning" value="Actualizar Información">Actualizar Información</button>
                                                        <a href="../../vista/planilla.php" class="btn btn-success">Regresar</a>
                                                </div>
                                            </form>
                                            <?php
                                            }
