                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-9 col-md-8">
                                <h1 class="font-weight-bold mb-0">Edición de Proveedores</h1><br>
                        </div>
                    </div>
                </section>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 d-flex stat my-4">
                                        <div class="mx-auto">
                                            ...
                                            $consulta = "SELECT * FROM proveedores_ard WHERE IdProveedor='" . $id . "'";
                                            ...
                                            ?>
                                            <form class="row g-3" action="../proveedores/csActualizarProv.php"
                                                method="post">
                                                ...
                                                <div class="col-md-6 py-2">
                                                    <label for="inputNEmpleado" class="form-label">Nombre de
                                                        Proveedor</label>
                                                    <input type="text" class="form-control" name="nprov" value="<?php echo $datos['Prov_Nombre'] ?>">
                                                </div>
                                                <div class="col-md-6 py-2">
                                                    <label for="inputDPI" class="form-label">Dirección</label>
                                                    <input type="text" class="form-control" maxlength="249" name="direccion" value="<?php echo $datos['Prov_Direccion'] ?>">
                                                </div>
                                                <div class="col-md-6 py-2">
                                                    <label for="inputBeneficios" class="form-label">NIT</label>
                                                    <input type="text" class="form-control" name="nit" maxlength="19" value="<?php echo $datos['Prov_NIT'] ?>">
                                                </div>
                                                <div class="col-md-6 py-2">
                                                    <label for="inputDireccion" class="form-label">Teléfono</label>
                                                    <input type="text" class="form-control" name="telefono"
                                                    oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                                                    maxlength="8" value="<?php echo $datos['Prov_Telefono'] ?>">
                                                </div>
                                                <div class="col-md-6 py-2">
                                                ...
                                                <div class="col-md-6 py-2">
                                                    ...
                                                    <input type="text" class="form-control" name="presentaciones" value="<?php echo $datos['Prov_Presentaciones'] ?>">
                                                </div>
                                                <div class="col-md-7 py-3">
                                                        <button type="submit" class="btn btn-warning" value="Actualizar Información">Actualizar Información</button>
                                                        <a href="../../vista/proveedores.php" class="btn btn-success">Regresar</a>
                                                </div>
                                            </form>
                                            <?php
                                            }
