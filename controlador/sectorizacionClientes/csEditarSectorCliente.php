                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-9 col-md-8">
                                <h1 class="font-weight-bold mb-0">Edición de Sectores / Rutas </h1><br>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 d-flex stat my-4">
                                        <div class="mx-auto">
                                            ...
                                            $consulta = "SELECT * FROM sectorizacion_clientes_ard WHERE IdSector ='" . $id . "'";
                                            ...
                                            ?>
                                            <form class="row g-3" action="../sectorizacionClientes/csActualizarSectorCliente.php"
                                                method="post">
                                                <input type="hidden" class="form-control" name="txtid"
                                                    value="<?php echo $datos['IdSector'] ?>">

                                                    <div class="col-md-12 py-2">
                                                    <label for="inputEmail4" class="form-label">Nombre del Sector / Ruta<span class = "red" style="color: red;">*</span></label>
                                                    <input type="text" class="form-control" name="nsector" maxlength="49" placeholder="Ej: Ruta 'Las Lisas'" 
                                                    value="<?php echo $datos['Sector_Nombre_Ruta'] ?>" required>
                                                    </div>
                                                    <div class="col-md-12 py-2">
                                                    <label for="inputEmail4" class="form-label">Desde (Origen) <span class = "red" style="color: red;">*</span></label>
                                                    <input type="text" class="form-control" name="desdeorigen" maxlength="49" placeholder="Ej: Villa Nueva" 
                                                    value="<?php echo $datos['Sector_DesdeOrigen'] ?>" required>
                                                    </div>

                                                    <div class="col-md-12 py-2">
                                                    <label for="inputEmail4" class="form-label">Hasta (Destino) <span class = "red" style="color: red;">*</span></label>
                                                    <input type="text" class="form-control" name="hastadestino" maxlength="49" placeholder="Ej: Antigua Guatemala" 
                                                    value="<?php echo $datos['Sector_HastaOrigen'] ?>" required>
                                                    </div>

                                                    <div class="col-md-12 py-2">
                                                    <label for="inputPassword4" class="form-label">Explicación de la Ruta <span class = "red" style="color: red;">*</span></label>
                                                    <input text="text" class="form-control" name="explicacionruta" maxlength="249" 
                                                    placeholder="Ej: Ruta de Guatemala a Petén, comprendido entre la 8va Calle 1-52, a las direcciones 8-25, etc" 
                                                    value="<?php echo $datos['Sector_ExplicacionRuta'] ?>" required></input>
                                                    </div>
                                                    ...
                                                    value="<?php echo $datos['Sector_PilotoAsignado'] ?>">
                                                    </div>
                                                    ...
                                                    value="<?php echo $datos['Sector_TipoDeVehiculo'] ?>">
                                                    </div>
                                                    ...
                                                    value="<?php echo $datos['Sector_YearVehiculo'] ?>">
                                                    </div>
                                                    ...
                                                    value="<?php echo $datos['Sector_ModeloVehiculo'] ?>">
                                                    </div>
                                                    ...
                                                    value="<?php echo $datos['Sector_ColorVehiculo'] ?>">
                                                    </div>

                                                    <div class="col-md-6 py-2">
                                                    <label for="inputEmail4" class="form-label">Placa del Vehículo</label>
                                                    <input type="text" class="form-control" name="placa" maxlength="49" placeholder="Ej: C452BTP"
                                                    value="<?php echo $datos['Sector_PlacaVehiculo'] ?>">
                                                    </div>

                                                    <div class="col-md-6 py-3">
                                                        <button type="submit" class="btn btn-warning" value="Actualizar Información">Actualizar Información</button>
                                                        <a href="../../vista/sectorizacionClientes.php" class="btn btn-success">Regresar</a>
                                                </div>
                                            </form>
                                            <?php
                                            }
