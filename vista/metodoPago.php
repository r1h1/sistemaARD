...
<head>
    ...
    <title>Métodos de Pago | SGE</title>
</head>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-9 col-md-8">
                                <h1 class="font-weight-bold mb-0">Métodos de Pago</h1><br>
                        </div>
                    </div>
                </section>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 d-flex my-3">
                                        <div class="mx-auto">
                                            ...
                                            <form class="row g-3"
                                                action="../controlador/metodoPago/csInsertarMetodoPago.php" method="POST">
                                                ...
                                                <div class="col-md-6 py-2">
                                                    ...
                                                    <input type="text" class="form-control" name="tipoPago"
                                                        placeholder="Ej: Efectivo" maxlength="49" required>
                                                </div>                         

                                                <div class="col-md-6 py-2">
                                                    <label for="inputNEmpleado" class="form-label">Porcentaje de Recargo por Transacción (%)</label>
                                                    <input type="number" class="form-control" name="recargoPago"
                                                        placeholder="Ej: 25" maxlength="29">
                                                </div>

                                                <div class="col-md-6 py-3">
                                                    <button type="submit" class="btn btn-success">Agregar Método de Pago</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <table class="table" id="tabla-mostrar">
                                            ...
                                            <div class="col-md-8 input-group mb-5">
                                                ...
                                                <a href="../vista/metodoPago" type="submit"  class="btn btn-success" id="return" name="return"><ion-icon name="clipboard" style="font-size: 20px"></ion-icon></a>
                                            </div>
                                            <thead>
                                                <tr>
                                                    <th scope="col">Tipo de Pago</th>
                                                    <th scope="col">Recargo por Pago (%)</th>                                                    
                                                </tr>
                                                <?php
                                                    include("../controlador/metodoPago/csListarMetodoPago.php");
                                                 ?>
                                        </table>
                                    </div>
                                </div>
