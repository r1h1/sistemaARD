                ...
                <section class="bg-light py-4">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-10">
                                <h1 class="font-weight-bold mb-0">Ventas</h1><br>
                            </div>
                            ...
                            <div class="col-12 mt-5 mb-4">
                                ...
                                $sql = "SELECT SUM(Venta_Total) FROM ventas_ard";
                                $totalFact = mysqli_query($conexion, $sql);
                                ...
                                clearstatcache();
                                mysqli_free_result($totalFact);

                                ?>
                                <h4 class="font-weight-bold">Total Vendido: <span class="h5 alert alert-secondary">Q<?php echo $total ?></span></h4>
                            </div>
                                    ...
                                    <div class="table-responsive w-100">
                                        <table class="table" id="tabla-mostrar">
                                            <div class="col-md-8 input-group mb-5">
                                                ...
                                                <a href="../vista/facturas.php" title="Ver todos los registros" type="submit" class="btn btn-success" id="return" name="return">
                                            ...
                                            <thead>
                                                ...
                                                <?php
                                                include("../controlador/facturas/csListarFacturas.php");
                                                ?>
                                        </table>
                                    </div>
                                </div>
