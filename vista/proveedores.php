                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-9 col-md-8">
                                <h1 class="font-weight-bold mb-0">Proveedores</h1><br>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 d-flex my-3">
                                        <div class="mx-auto">
                                            ...
                                            <form class="row g-3"
                                                action="../controlador/proveedores/csInsertarProv.php" method="POST">
                                                <div class="col-md-6 py-2">
                                                    <label for="inputNEmpleado" class="form-label">Nombre de
                                                        Proveedor <span class = "red" style="color: red;">*</span></label>
                                                    <input type="text" class="form-control" name="nprov"
                                                        placeholder="Ej: Almacen 'LA LUZ'" required>
                                                </div>
                                                <div class="col-md-6 py-2">
                                                    <label for="inputDPI" class="form-label">Dirección <span class = "red" style="color: red;">*</span></label>
                                                    <input type="text" class="form-control" name="direccion"
                                                        placeholder="Ej: Ciudad" maxlength="249" required>
                                                </div>
                                                <div class="col-md-6 py-2">
                                                    <label for="inputBeneficios" class="form-label">NIT <span class = "red" style="color: red;">*</span></label>
                                                    <input type="text" class="form-control" maxlength="19" name="nit" placeholder="Ej: 145558754" required>
                                                </div>
                                                <div class="col-md-6 py-2">
                                                    <label for="inputDireccion" class="form-label">Teléfono <span class = "red" style="color: red;">*</span></label>
                                                ...
                                                <div class="col-md-6 py-2">
                                                    ...
                                                    <input type="text" class="form-control" name="presentaciones" placeholder="Ej: Sachet">
                                                </div>
                                                <div class="col-md-6 py-2">
                                    ...
                                    <div class="table-responsive w-100 w-100">
                                        <table class="table" id="tabla-mostrar">
                                            ...
                                            <div class="col-md-8 input-group mb-5">
                                                ...
                                                <a href="../vista/proveedores" type="submit"  class="btn btn-success" id="return" name="return"><ion-icon name="clipboard" style="font-size: 20px"></ion-icon></a>
                                            </div>
                                            <thead>
                                                <tr>
                                                ...
                                                <?php
                          include("../controlador/proveedores/csListarProv.php");
                        ?>
                                        </table>
                                    </div>
                                </div>
